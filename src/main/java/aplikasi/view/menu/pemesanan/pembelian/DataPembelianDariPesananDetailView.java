 ...
 * @author dimmaryanto
 */
public class DataPembelianDariPesananDetailView extends javax.swing.JDialog {
    ...
    DataPembelianDariPesananDetailView(MainMenuView menuController, boolean modal,
            DataPembelianDariPemesananView pembelianController, Pembelian pembelian) {
    ...
    private void refreshDataTable() {
        try {
            ...
            Logger.getLogger(DataPembelianDariPesananDetailView.class.getName()).log(Level.SEVERE, null, ex);
        }
