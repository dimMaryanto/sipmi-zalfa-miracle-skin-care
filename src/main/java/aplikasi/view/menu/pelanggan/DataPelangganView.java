 ...
 * @author dimmaryanto
 */
public class DataPelangganView extends javax.swing.JDialog {

    private static final long serialVersionUID = 1L;
    private final RepoPelanggan repo = new ServicePelanggan(KoneksiDB.getDataSource());
    private Boolean update;
    private Pelanggan pelanggan;
    private DaftarPelangganView daftarPelanggan;
     ...
     * @param modal
     */
    public DataPelangganView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setUpdate(false);
        ...
        try {
            ...
            Logger.getLogger(DataPelangganView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public DataPelangganView(java.awt.Frame parent, DaftarPelangganView daftarPelangganView, boolean modal) {
        super(parent, modal);
        initComponents();
        setUpdate(false);
    ...
    public DataPelangganView(java.awt.Frame parent, boolean modal, Pelanggan p, DaftarPelangganView daftarPelanggan) {
        super(parent, modal);
        initComponents();
        setUpdate(true);
        setFields(p);
