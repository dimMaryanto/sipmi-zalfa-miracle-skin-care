 ...
 * @author dimmaryanto
 */
public class DataPenjualanDetailView extends javax.swing.JDialog {
    ...
    private final DataPenjualanView penjualanController;
    private final Penjualan penjualan;
    private final PenjualanDetail detailPenjualan;
    private final Pelanggan pelanggan;

    DataPenjualanDetailView(java.awt.Frame parent, boolean modal, DataPenjualanView penjualanController, Penjualan penjualan, Pelanggan pelanggan) {
        super(parent, modal);
        initComponents();
        ...
        this.detailPenjualan = new PenjualanDetail();
    ...
    public final void refreshDataTable() {
        try {
            ...
            Logger.getLogger(DataPenjualanDetailView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        txtJumlahJual.setModel(new javax.swing.SpinnerNumberModel(1, 1, null, 5));
